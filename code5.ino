...
int turnLeft(int x, int y) //входящие переменные: 1.расстояние для поворота 1 мотора, 2. расстояние для поворота 2 мотора
{
  while (c > x || c1 < y)
  {
    if (i == 0)
...
int turnRight(int x, int y) //входящие переменные: 1.расстояние для поворота 1 мотора, 2. расстояние для поворота 2 мотора
{
  while (c < x || c1 > y)
  {
    if (i == 0)
...
int forward(int x, int z, int n, boolean p) //входящие переменные: 1.расстояние для 1 мотора, 2. наряжение левого для мотора 3. напряжение для правого мотора 4. напряжение для направления 1 мотора(True || False)
{
  //while (f < x || f1 < x)  //idea#1
  //while ((f < x || f1 < x) || c!=c1)   //idea#2
  while (f < x && f1 < x)
  {
    if (i == 0)
    {
...
{
  //движение вперед 50 50 LOW
  //поворот на 90 градусов итерации: -19 19.
  //примеры:
  //turnLeft/turnRight(расстояние для поворота 1 мотора, расстояние для поворота 2 мотора);
  ...
  forward(170, 80, 58, false);
  turnLeft(-23, 23);
  forward(145, 80, 58, false);
  turnLeft(-23, 23);
  forward(33, 80, 58, false);
  turnRight(23, -23);
  forward(190, 80, 58, false);
  /*
    turnLeft(-20, 20);
    ...
    forward(315, 50, 50, false);
         ...
         forward(297, 50, 50, false);
         turnRight(20, -20);
         forward(213, 50, 50, false);
         turnRight(20, -20);
         forward(211, 50, 50, false);
         turnRight(20, -20);
         forward(367, 50, 50, false);
         turnLeft(20, -20);
         forward(68, 50, 50, false);

      forward(20, 50, 50, false);
      turnLeft(-20, 20);
      forward(20, 50, 50, false);
      turnLeft(-20, 20);
      forward(20, 50, 50, false);
